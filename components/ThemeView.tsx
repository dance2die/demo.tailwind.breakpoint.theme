...
// const ThemeBox = ({ name, value }) => <Box width="w-1/3" height="h-44" name={name} value={value} />;
	...
	return (
		<div className="w-8/12 mx-auto">
			<section className="flex w-full h-full">
				<div className="flex flex-col px-4 py-3 justify-between w-1/3 h-44 bg-primary">
					<span className="font-semibold text-on-primary">primary</span>
				...
				<div className="flex flex-col px-4 py-3 justify-between w-1/3 h-44 bg-primary-light">
					<span className="font-semibold text-on-primary">primary-light</span>
					<div className="flex justify-between">
				...
				<div className="flex flex-col px-4 py-3 justify-between w-1/3 h-44 bg-primary-dark">
					<span className="font-semibold text-on-primary">primary-dark</span>
					<div className="flex justify-between">
			...
			<section className="flex w-full h-full">
				<div className="flex flex-col px-4 py-3 justify-between w-1/3 h-44 bg-secondary">
					<span className="font-semibold text-on-secondary">secondary</span>
					<div className="flex justify-between">
				...
				<div className="flex flex-col px-4 py-3 justify-between w-1/3 h-44 bg-secondary-light">
					<span className="font-semibold text-on-secondary">secondary-light</span>
					<div className="flex justify-between">
						<span className="bg-on-secondary text-on-primary w-6 grid place-items-center rounded-full">
							5
						</span>
				...
				<div className="flex flex-col px-4 py-3 justify-between w-1/3 h-44 bg-secondary-dark">
					<span className="font-semibold text-on-secondary">secondary-dark</span>
					<div className="flex justify-between">
						<span className="bg-on-secondary text-on-primary w-6 grid place-items-center rounded-full">
							6
						</span>
			...
			<section className="flex w-full h-full divide-x-2">
				<div className="flex flex-col px-4 py-3 justify-between w-1/3 h-24 bg-background">
					<span className="font-semibold text-on-secondary">background</span>
					<div className="flex justify-between">
						<span className="bg-on-secondary text-on-primary w-6 grid place-items-center rounded-full">
							7
						</span>
				...
				<div className="flex flex-col px-4 py-3 justify-between w-1/3 h-24 bg-error">
					<span className="font-semibold text-on-primary">error</span>
					<div className="flex justify-between">
			...
			<section className="flex w-full h-full divide-x-2">
				<div className="flex flex-col px-4 py-3 justify-between w-1/2 h-24 bg-on-primary">
					<span className="font-semibold text-on-secondary">on-primary</span>
					<div className="flex justify-between">
						<span className="bg-on-secondary text-on-primary w-6 grid place-items-center rounded-full">
							10
						</span>
				...
				<div className="flex flex-col px-4 py-3 justify-between w-1/2 h-24 bg-on-secondary">
					<span className="font-semibold text-on-primary">on-secondary</span>
					<div className="flex justify-between">
						<span className="bg-on-primary text-on-secondary w-6 grid place-items-center rounded-full">
							11
						</span>
			...
			<section className="flex w-full h-full divide-x-2">
				<div className="flex flex-col px-4 py-3 justify-between w-1/2 h-24 bg-on-background">
					<span className="font-semibold text-on-primary">on-background</span>
					<div className="flex justify-between">
						<span className="bg-on-secondary text-on-primary w-6 grid place-items-center rounded-full">
							12
						</span>
				...
				<div className="flex flex-col px-4 py-3 justify-between w-1/2 h-24 bg-on-surface">
					<span className="font-semibold text-on-primary">on-surface</span>
					<div className="flex justify-between">
				...
				<div className="flex flex-col px-4 py-3 justify-between w-1/2 h-24 bg-on-error">
					<span className="font-semibold text-on-secondary">on-error</span>
					<div className="flex justify-between">
